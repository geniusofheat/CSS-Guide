// § 1 — A-TO-Z CSS PROPERTIES LESSONS
// Source: W3Schools CSS Reference
// Dataset name: atoz_properties_lessons
// Section: A

const atoz_properties_lessons = [
...
Correct:   background-size: 100px;`,
...

  {
    ...
    category: "CSS1",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/pr_border.php",
    definition: "Shorthand property for setting the width, style, and color of all four borders of an element in one declaration.",
    default_value: "medium none currentColor",
    inherited: "no",
    animatable: "yes",
    applies_to: ["all elements"],
    tip: "The border style is required. If no style is set, the border will not display regardless of width or color.",
    note: `Order: width style color. All three can be in any order but style is required.
Correct:   border: 2px solid #c8a96e;
Incorrect: border: 2px #c8a96e; (missing style — no border will show)`,
    syntax: "border: width style color | initial | inherit;",
    values: [
      {
        value: "border-width",
        description: "Thickness of the border. Can use keywords (thin, medium, thick) or length values.",
        syntax_example: "div { border: 2px solid #000; }",
        units_note: "Accepts px, em, rem. Do not add a space between value and unit: border: 2px solid (correct), border: 2 px solid (incorrect)."
      },
      {
        value: "border-style",
        description: "Required. Defines the line style: none, solid, dashed, dotted, double, groove, ridge, inset, outset.",
        syntax_example: "div { border: 1px dashed #c8a96e; }"
      },
      {
        value: "border-color",
        description: "The color of the border. Accepts any valid CSS color value.",
        syntax_example: "div { border: 1px solid red; }"
      },
      {
        value: "initial",
        description: "Resets all border sub-properties to their defaults.",
        syntax_example: "div { border: initial; }"
      },
      {
        value: "inherit",
        description: "Inherits all border sub-properties from the parent element.",
        syntax_example: "div { border: inherit; }"
      }
    ],
    examples: [
      {
        label: "Common border declarations",
        code: `div.a { border: 2px solid #c8a96e; }
div.b { border: 1px dashed #333; }
div.c { border: 4px double red; }
div.d { border: thin dotted blue; }`
      }
    ],
    browser_support: {
      chrome: "1",
...

  {
    ...
    category: "CSS",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/css_pr_border-block.php",
    definition: "Shorthand for setting the width, style, and color of the block-direction borders (top and bottom in horizontal writing modes) in one declaration.",
    default_value: "medium none currentColor",
    inherited: "no",
    animatable: "no",
    applies_to: ["all elements"],
    note: "Part of CSS Logical Properties. In a standard horizontal writing mode, border-block sets the top and bottom borders. In a vertical writing mode, it sets the left and right borders.",
    syntax: "border-block: width style color | initial | inherit;",
    values: [
      {
        value: "border-width",
        description: "The thickness of the block-direction borders.",
        syntax_example: "div { border-block: 2px solid #c8a96e; }"
      },
      {
        value: "border-style",
        description: "The line style of the block-direction borders.",
        syntax_example: "div { border-block: 1px dashed #333; }"
      },
      {
        value: "border-color",
        description: "The color of the block-direction borders.",
        syntax_example: "div { border-block: 2px solid red; }"
      },
      {
        value: "initial",
        description: "Resets to default values.",
        syntax_example: "div { border-block: initial; }"
      },
      {
        value: "inherit",
        description: "Inherits from the parent element.",
        syntax_example: "div { border-block: inherit; }"
      }
    ],
    examples: [
      {
        label: "Set top and bottom borders logically",
        code: `div {
  border-block: 2px solid #c8a96e;
}`
      }
    ],
    browser_support: {
...

  {
    ...
    category: "CSS",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/css_pr_border-block-color.php",
    definition: "Sets the color of the block-direction borders (top and bottom in horizontal writing modes).",
    default_value: "currentColor",
    inherited: "no",
    animatable: "yes",
    applies_to: ["all elements"],
    syntax: "border-block-color: color | initial | inherit;",
    values: [
      {
        value: "color",
        description: "Any valid CSS color value for the block-direction borders.",
        syntax_example: "div { border-block-color: #c8a96e; }"
      },
      {
        value: "initial",
        description: "Resets to default value (currentColor).",
        syntax_example: "div { border-block-color: initial; }"
      },
      {
        value: "inherit",
        description: "Inherits from the parent element.",
        syntax_example: "div { border-block-color: inherit; }"
      }
    ],
    examples: [
      {
        label: "Color top and bottom borders",
        code: `div {
  border-block-style: solid;
  border-block-width: 2px;
  border-block-color: #c8a96e;
}`
      }
    ],
    browser_support: {
...

  {
    ...
    category: "CSS",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/css_pr_border-block-end.php",
    definition: "Shorthand for setting the width, style, and color of the block-end border (bottom border in horizontal writing modes).",
    default_value: "medium none currentColor",
    inherited: "no",
    animatable: "no",
    applies_to: ["all elements"],
    syntax: "border-block-end: width style color | initial | inherit;",
    values: [
      {
        value: "border-width",
        description: "Thickness of the block-end border.",
        syntax_example: "div { border-block-end: 2px solid #c8a96e; }"
      },
      {
        value: "border-style",
        description: "Style of the block-end border.",
        syntax_example: "div { border-block-end: 1px dashed #333; }"
      },
      {
        value: "border-color",
        description: "Color of the block-end border.",
        syntax_example: "div { border-block-end: 2px solid red; }"
      },
      {
        value: "initial",
        description: "Resets to defaults.",
        syntax_example: "div { border-block-end: initial; }"
      },
      {
        value: "inherit",
        description: "Inherits from the parent.",
        syntax_example: "div { border-block-end: inherit; }"
      }
    ],
    examples: [
      {
        label: "Set bottom border logically",
        code: `div {
  border-block-end: 2px solid #c8a96e;
}`
      }
    ],
    browser_support: {
...

  {
    ...
    category: "CSS",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/css_pr_border-block-end-color.php",
    definition: "Sets the color of the block-end border (bottom border in horizontal writing modes).",
    default_value: "currentColor",
    inherited: "no",
    animatable: "yes",
    applies_to: ["all elements"],
    syntax: "border-block-end-color: color | initial | inherit;",
    values: [
      {
        value: "color",
        description: "Any valid CSS color value.",
        syntax_example: "div { border-block-end-color: #c8a96e; }"
      },
      {
        value: "initial",
        description: "Resets to default (currentColor).",
        syntax_example: "div { border-block-end-color: initial; }"
      },
      {
        value: "inherit",
        description: "Inherits from parent.",
        syntax_example: "div { border-block-end-color: inherit; }"
      }
    ],
    examples: [
      {
        label: "Color the bottom border logically",
        code: `div {
...

  {
    ...
    category: "CSS",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/css_pr_border-block-end-style.php",
    definition: "Sets the style of the block-end border (bottom border in horizontal writing modes).",
    default_value: "none",
    inherited: "no",
    animatable: "no",
    applies_to: ["all elements"],
    syntax: "border-block-end-style: none | solid | dashed | dotted | double | groove | ridge | inset | outset | initial | inherit;",
    values: [
      {
        value: "none",
        description: "Default. No border is shown.",
        syntax_example: "div { border-block-end-style: none; }"
      },
      {
        value: "solid",
        description: "A solid line.",
        syntax_example: "div { border-block-end-style: solid; }"
      },
      {
        value: "dashed",
        description: "A dashed line.",
        syntax_example: "div { border-block-end-style: dashed; }"
      },
      {
        value: "dotted",
        description: "A dotted line.",
        syntax_example: "div { border-block-end-style: dotted; }"
      },
      {
        value: "double",
        description: "Two solid lines.",
        syntax_example: "div { border-block-end-style: double; }"
      },
      {
        value: "initial",
        description: "Resets to default (none).",
        syntax_example: "div { border-block-end-style: initial; }"
      },
      {
        value: "inherit",
        description: "Inherits from parent.",
        syntax_example: "div { border-block-end-style: inherit; }"
      }
    ],
    examples: [
      {
        label: "Dashed bottom border logically",
        code: `div {
  border-block-end-style: dashed;
  border-block-end-width: 2px;
  border-block-end-color: #c8a96e;
}`
      }
    ],
    browser_support: {
...

  {
    ...
    category: "CSS",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/css_pr_border-block-end-width.php",
    definition: "Sets the width of the block-end border (bottom border in horizontal writing modes).",
    default_value: "medium",
    inherited: "no",
    animatable: "yes",
    applies_to: ["all elements"],
    syntax: "border-block-end-width: thin | medium | thick | length | initial | inherit;",
    values: [
      {
        value: "thin",
        description: "A thin border (typically 1px).",
        syntax_example: "div { border-block-end-width: thin; }"
      },
      {
        value: "medium",
        description: "Default. A medium border (typically 3px).",
        syntax_example: "div { border-block-end-width: medium; }"
      },
      {
        value: "thick",
        description: "A thick border (typically 5px).",
        syntax_example: "div { border-block-end-width: thick; }"
      },
      {
        value: "length",
        description: "A specific length value.",
        syntax_example: "div { border-block-end-width: 4px; }",
        units_note: "Accepts px, em, rem."
      },
      {
        value: "initial",
        description: "Resets to default (medium).",
        syntax_example: "div { border-block-end-width: initial; }"
      },
      {
        value: "inherit",
        description: "Inherits from parent.",
        syntax_example: "div { border-block-end-width: inherit; }"
      }
    ],
    examples: [
      {
        label: "Set bottom border width logically",
        code: `div {
  border-block-end-style: solid;
...

  {
    ...
    category: "CSS",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/css_pr_border-block-start.php",
    definition: "Shorthand for setting the width, style, and color of the block-start border (top border in horizontal writing modes).",
    default_value: "medium none currentColor",
    inherited: "no",
    animatable: "no",
    applies_to: ["all elements"],
    syntax: "border-block-start: width style color | initial | inherit;",
    values: [
      {
        value: "border-width",
        description: "Thickness of the block-start border.",
        syntax_example: "div { border-block-start: 2px solid #c8a96e; }"
      },
      {
        value: "border-style",
        description: "Style of the block-start border.",
        syntax_example: "div { border-block-start: 1px dashed #333; }"
      },
      {
        value: "border-color",
        description: "Color of the block-start border.",
        syntax_example: "div { border-block-start: 2px solid red; }"
      },
      {
        value: "initial",
        description: "Resets to defaults.",
        syntax_example: "div { border-block-start: initial; }"
      },
      {
        value: "inherit",
        description: "Inherits from parent.",
        syntax_example: "div { border-block-start: inherit; }"
      }
    ],
    examples: [
      {
        label: "Set top border logically",
        code: `div {
  border-block-start: 2px solid #c8a96e;
}`
      }
    ],
    browser_support: {
...

  {
    ...
    category: "CSS",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/css_pr_border-block-start-color.php",
    definition: "Sets the color of the block-start border (top border in horizontal writing modes).",
    default_value: "currentColor",
    inherited: "no",
    animatable: "yes",
    applies_to: ["all elements"],
    syntax: "border-block-start-color: color | initial | inherit;",
    values: [
      { value: "color", description: "Any valid CSS color.", syntax_example: "div { border-block-start-color: #c8a96e; }" },
      { value: "initial", description: "Resets to default.", syntax_example: "div { border-block-start-color: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "div { border-block-start-color: inherit; }" }
    ],
    examples: [{ label: "Color the top border logically", code: `div { border-block-start-style: solid; border-block-start-width: 2px; border-block-start-color: gold; }` }],
...

  {
    ...
    category: "CSS",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/css_pr_border-block-start-style.php",
    definition: "Sets the style of the block-start border (top border in horizontal writing modes).",
    default_value: "none",
    inherited: "no",
    animatable: "no",
    applies_to: ["all elements"],
    syntax: "border-block-start-style: none | solid | dashed | dotted | double | groove | ridge | inset | outset | initial | inherit;",
    values: [
      { value: "none", description: "Default. No border.", syntax_example: "div { border-block-start-style: none; }" },
      { value: "solid", description: "A solid line.", syntax_example: "div { border-block-start-style: solid; }" },
      { value: "dashed", description: "A dashed line.", syntax_example: "div { border-block-start-style: dashed; }" },
      { value: "initial", description: "Resets to default.", syntax_example: "div { border-block-start-style: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "div { border-block-start-style: inherit; }" }
    ],
    examples: [{ label: "Solid top border logically", code: `div { border-block-start-style: solid; border-block-start-width: 2px; border-block-start-color: #c8a96e; }` }],
    browser_support: { chrome: "69", edge: "79", firefox: "41", safari: "12.1", opera: "56" }
  },

  {
    ...
    category: "CSS",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/css_pr_border-block-start-width.php",
    definition: "Sets the width of the block-start border (top border in horizontal writing modes).",
    default_value: "medium",
    inherited: "no",
    animatable: "yes",
    applies_to: ["all elements"],
    syntax: "border-block-start-width: thin | medium | thick | length | initial | inherit;",
    values: [
      { value: "thin", description: "A thin border.", syntax_example: "div { border-block-start-width: thin; }" },
      { value: "medium", description: "Default. A medium border.", syntax_example: "div { border-block-start-width: medium; }" },
      { value: "thick", description: "A thick border.", syntax_example: "div { border-block-start-width: thick; }" },
      { value: "length", description: "A specific length.", syntax_example: "div { border-block-start-width: 3px; }", units_note: "Accepts px, em, rem." },
      { value: "initial", description: "Resets to default.", syntax_example: "div { border-block-start-width: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "div { border-block-start-width: inherit; }" }
    ],
    examples: [{ label: "Set top border width logically", code: `div { border-block-start-style: solid; border-block-start-width: 3px; border-block-start-color: #c8a96e; }` }],
    browser_support: { chrome: "69", edge: "79", firefox: "41", safari: "12.1", opera: "56" }
  },

  {
    ...
    category: "CSS",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/css_pr_border-block-style.php",
    definition: "Sets the style for both block-direction borders (top and bottom in horizontal writing modes).",
    default_value: "none",
    inherited: "no",
    animatable: "no",
    applies_to: ["all elements"],
    syntax: "border-block-style: none | solid | dashed | dotted | double | groove | ridge | inset | outset | initial | inherit;",
    values: [
      { value: "none", description: "Default. No border.", syntax_example: "div { border-block-style: none; }" },
      { value: "solid", description: "Solid borders on top and bottom.", syntax_example: "div { border-block-style: solid; }" },
      { value: "dashed", description: "Dashed borders on top and bottom.", syntax_example: "div { border-block-style: dashed; }" },
      { value: "initial", description: "Resets to default.", syntax_example: "div { border-block-style: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "div { border-block-style: inherit; }" }
    ],
    examples: [{ label: "Solid top and bottom borders logically", code: `div { border-block-style: solid; border-block-width: 2px; border-block-color: #c8a96e; }` }],
...

  {
    ...
    category: "CSS",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/css_pr_border-block-width.php",
    definition: "Sets the width for both block-direction borders (top and bottom in horizontal writing modes).",
    default_value: "medium",
    inherited: "no",
    animatable: "yes",
    applies_to: ["all elements"],
    syntax: "border-block-width: thin | medium | thick | length | initial | inherit;",
    values: [
      { value: "thin", description: "Thin borders.", syntax_example: "div { border-block-width: thin; }" },
      { value: "medium", description: "Default. Medium borders.", syntax_example: "div { border-block-width: medium; }" },
      { value: "thick", description: "Thick borders.", syntax_example: "div { border-block-width: thick; }" },
      { value: "length", description: "Specific length value.", syntax_example: "div { border-block-width: 2px; }", units_note: "Accepts px, em, rem." },
      { value: "initial", description: "Resets to default.", syntax_example: "div { border-block-width: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "div { border-block-width: inherit; }" }
    ],
    examples: [{ label: "Set top and bottom border widths logically", code: `div { border-block-style: solid; border-block-width: 4px; border-block-color: #c8a96e; }` }],
    browser_support: { chrome: "87", edge: "87", firefox: "66", safari: "14.1", opera: "73" }
  },

  {
    ...
    category: "CSS1",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/pr_border-bottom.php",
    definition: "Shorthand for setting the width, style, and color of the bottom border in one declaration.",
    default_value: "medium none currentColor",
    inherited: "no",
    animatable: "yes",
    applies_to: ["all elements"],
    syntax: "border-bottom: width style color | initial | inherit;",
    values: [
      { value: "border-bottom-width", description: "Thickness of the bottom border.", syntax_example: "div { border-bottom: 2px solid #c8a96e; }" },
      { value: "border-bottom-style", description: "Style of the bottom border. Required for border to display.", syntax_example: "div { border-bottom: 1px dashed #333; }" },
      { value: "border-bottom-color", description: "Color of the bottom border.", syntax_example: "div { border-bottom: 2px solid red; }" },
      { value: "initial", description: "Resets to defaults.", syntax_example: "div { border-bottom: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "div { border-bottom: inherit; }" }
    ],
    examples: [{ label: "Bottom border only", code: `div {\n  border-bottom: 2px solid #c8a96e;\n}` }],
...

  {
    ...
    category: "CSS1",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/pr_border-bottom_color.php",
    ...
    values: [
      { value: "color", description: "Any valid CSS color value.", syntax_example: "div { border-bottom-color: #c8a96e; }" },
      { value: "transparent", description: "Makes the bottom border transparent.", syntax_example: "div { border-bottom-color: transparent; }" },
      { value: "initial", description: "Resets to default.", syntax_example: "div { border-bottom-color: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "div { border-bottom-color: inherit; }" }
    ],
    examples: [{ label: "Gold bottom border color", code: `div {\n  border-bottom-style: solid;\n  border-bottom-width: 2px;\n  border-bottom-color: #c8a96e;\n}` }],
    browser_support: { chrome: "1", edge: "12", firefox: "1", safari: "1", opera: "3.5" }
  },

  {
    ...
    category: "CSS3",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/css3_pr_border-bottom-left-radius.php",
    definition: "Defines the radius of the bottom-left corner of an element.",
    default_value: "0",
    inherited: "no",
    animatable: "yes",
    applies_to: ["all elements except table rows, row groups, columns, and column groups"],
    syntax: "border-bottom-left-radius: length | % | initial | inherit;",
    values: [
      { value: "length", description: "Defines the radius as a fixed length. One value sets a circular radius; two values set an elliptical radius.", syntax_example: "div { border-bottom-left-radius: 10px; }", units_note: "Accepts px, em, rem." },
      { value: "%", description: "Defines the radius as a percentage of the element's dimensions.", syntax_example: "div { border-bottom-left-radius: 50%; }" },
      { value: "initial", description: "Resets to default (0).", syntax_example: "div { border-bottom-left-radius: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "div { border-bottom-left-radius: inherit; }" }
    ],
    examples: [{ label: "Round bottom-left corner only", code: `div {\n  border-bottom-left-radius: 20px;\n  border: 2px solid #c8a96e;\n}` }],
...

  {
    ...
    category: "CSS3",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/css3_pr_border-bottom-right-radius.php",
    definition: "Defines the radius of the bottom-right corner of an element.",
    default_value: "0",
    inherited: "no",
    animatable: "yes",
    applies_to: ["all elements except table rows, row groups, columns, and column groups"],
    syntax: "border-bottom-right-radius: length | % | initial | inherit;",
    values: [
      { value: "length", description: "Fixed radius length.", syntax_example: "div { border-bottom-right-radius: 10px; }", units_note: "Accepts px, em, rem." },
      { value: "%", description: "Percentage radius.", syntax_example: "div { border-bottom-right-radius: 50%; }" },
      { value: "initial", description: "Resets to default (0).", syntax_example: "div { border-bottom-right-radius: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "div { border-bottom-right-radius: inherit; }" }
    ],
    examples: [{ label: "Round bottom-right corner only", code: `div {\n  border-bottom-right-radius: 20px;\n  border: 2px solid #c8a96e;\n}` }],
    browser_support: { chrome: "4", edge: "12", firefox: "4", safari: "5", opera: "10.5" }
  },

  {
    ...
    category: "CSS1",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/pr_border-bottom_style.php",
    definition: "Sets the style of the bottom border.",
    default_value: "none",
    inherited: "no",
    animatable: "no",
    applies_to: ["all elements"],
    syntax: "border-bottom-style: none | solid | dashed | dotted | double | groove | ridge | inset | outset | hidden | initial | inherit;",
    values: [
      { value: "none", description: "Default. No border.", syntax_example: "div { border-bottom-style: none; }" },
      { value: "solid", description: "A solid line.", syntax_example: "div { border-bottom-style: solid; }" },
      { value: "dashed", description: "A dashed line.", syntax_example: "div { border-bottom-style: dashed; }" },
      { value: "dotted", description: "A dotted line.", syntax_example: "div { border-bottom-style: dotted; }" },
      { value: "double", description: "Two solid lines.", syntax_example: "div { border-bottom-style: double; }" },
      { value: "groove", description: "A 3D grooved effect.", syntax_example: "div { border-bottom-style: groove; }" },
      { value: "ridge", description: "A 3D ridged effect.", syntax_example: "div { border-bottom-style: ridge; }" },
      { value: "inset", description: "A 3D inset effect.", syntax_example: "div { border-bottom-style: inset; }" },
      { value: "outset", description: "A 3D outset effect.", syntax_example: "div { border-bottom-style: outset; }" },
      { value: "hidden", description: "Same as none but takes space for table borders.", syntax_example: "div { border-bottom-style: hidden; }" },
      { value: "initial", description: "Resets to default.", syntax_example: "div { border-bottom-style: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "div { border-bottom-style: inherit; }" }
    ],
    examples: [{ label: "Dashed bottom border", code: `div {\n  border-bottom-style: dashed;\n  border-bottom-width: 2px;\n  border-bottom-color: #c8a96e;\n}` }],
    browser_support: { chrome: "1", edge: "12", firefox: "1", safari: "1", opera: "3.5" }
  },

  {
    ...
    category: "CSS1",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/pr_border-bottom_width.php",
    definition: "Sets the width of the bottom border.",
    default_value: "medium",
    inherited: "no",
    animatable: "yes",
    applies_to: ["all elements"],
    syntax: "border-bottom-width: thin | medium | thick | length | initial | inherit;",
    values: [
      { value: "thin", description: "A thin border.", syntax_example: "div { border-bottom-width: thin; }" },
      { value: "medium", description: "Default. A medium border.", syntax_example: "div { border-bottom-width: medium; }" },
      { value: "thick", description: "A thick border.", syntax_example: "div { border-bottom-width: thick; }" },
      { value: "length", description: "A specific length.", syntax_example: "div { border-bottom-width: 4px; }", units_note: "Accepts px, em, rem. No space between value and unit." },
      { value: "initial", description: "Resets to default.", syntax_example: "div { border-bottom-width: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "div { border-bottom-width: inherit; }" }
    ],
    examples: [{ label: "4px bottom border", code: `div {\n  border-bottom-style: solid;\n  border-bottom-width: 4px;\n  border-bottom-color: #c8a96e;\n}` }],
    browser_support: { chrome: "1", edge: "12", firefox: "1", safari: "1", opera: "3.5" }
  },

  {
    ...
    category: "CSS2",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/pr_border-collapse.php",
    definition: "Sets whether table borders are collapsed into a single border or separated with space between them.",
    default_value: "separate",
    inherited: "yes",
    animatable: "no",
    applies_to: ["table and inline-table elements"],
    tip: "Use border-collapse: collapse for a clean table appearance where adjacent cell borders merge into one.",
    syntax: "border-collapse: separate | collapse | initial | inherit;",
    values: [
      { value: "separate", description: "Default. Borders are separate. Use border-spacing to control the gap.", syntax_example: "table { border-collapse: separate; }" },
      { value: "collapse", description: "Adjacent borders merge into one. The border-spacing property is ignored.", syntax_example: "table { border-collapse: collapse; }" },
      { value: "initial", description: "Resets to default (separate).", syntax_example: "table { border-collapse: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "table { border-collapse: inherit; }" }
    ],
    examples: [{ label: "Clean collapsed table borders", code: `table {\n  border-collapse: collapse;\n}\n\ntable, th, td {\n  border: 1px solid #c8a96e;\n}` }],
...

  {
    ...
    category: "CSS1",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/pr_border-color.php",
    definition: "Sets the color of all four borders of an element. Can specify one to four values for individual sides.",
    default_value: "currentColor",
    inherited: "no",
    animatable: "yes",
    applies_to: ["all elements"],
    tip: "Like margin and padding, border-color follows the top/right/bottom/left shorthand order when multiple values are provided.",
    note: `1 value  = all four sides
2 values = top+bottom, left+right
3 values = top, left+right, bottom
4 values = top, right, bottom, left`,
    syntax: "border-color: color | transparent | initial | inherit;",
    values: [
      { value: "color", description: "Any valid CSS color for the borders.", syntax_example: "div { border-color: red green blue yellow; }" },
      { value: "transparent", description: "Makes the border transparent (space still taken).", syntax_example: "div { border-color: transparent; }" },
      { value: "initial", description: "Resets to default.", syntax_example: "div { border-color: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "div { border-color: inherit; }" }
    ],
    examples: [
      { label: "Different colors on each side", code: `div {\n  border-style: solid;\n  border-width: 4px;\n  border-color: red green blue yellow;\n}` }
    ],
    browser_support: { chrome: "1", edge: "12", firefox: "1", safari: "1", opera: "3.5" }
  },

  {
    ...
    category: "CSS3",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/css3_pr_border-image.php",
    definition: "Shorthand for using an image as the border of an element instead of the normal border style.",
    default_value: "none 100% 1 0 stretch",
    inherited: "no",
    animatable: "no",
    applies_to: ["all elements except table rows, row groups when border-collapse is collapse"],
    tip: "You still need to set border-width and border-style for border-image to display.",
    syntax: "border-image: source slice width outset repeat | initial | inherit;",
    values: [
      { value: "border-image-source", description: "The image to use as the border. Use url().", syntax_example: "div { border-image: url('border.png') 30 round; }" },
      { value: "border-image-slice", description: "How the image is sliced into regions.", syntax_example: "div { border-image: url('border.png') 30; }" },
      { value: "border-image-width", description: "The width of the border image.", syntax_example: "div { border-image: url('border.png') 30 / 10px; }" },
      { value: "border-image-outset", description: "How far the border image extends beyond the border box.", syntax_example: "div { border-image: url('border.png') 30 / 1 / 2; }" },
      { value: "border-image-repeat", description: "How the border image is tiled: stretch, repeat, round, space.", syntax_example: "div { border-image: url('border.png') 30 round; }" },
      { value: "initial", description: "Resets to defaults.", syntax_example: "div { border-image: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "div { border-image: inherit; }" }
    ],
    examples: [{ label: "Image border", code: `div {\n  border: 10px solid transparent;\n  border-image: url('border.png') 30 round;\n}` }],
    browser_support: { chrome: "16", edge: "12", firefox: "15", safari: "6", opera: "15" }
  },

  {
    ...
    category: "CSS3",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/css3_pr_border-radius.php",
    definition: "Shorthand for rounding all four corners of an element. Can set individual corner radii or apply to all corners at once.",
    default_value: "0",
    inherited: "no",
    animatable: "yes",
    applies_to: ["all elements except table rows, row groups, columns, and column groups"],
    tip: "Use border-radius: 50% on a square element to make a perfect circle.",
    note: `1 value  = all four corners
2 values = top-left+bottom-right, top-right+bottom-left
3 values = top-left, top-right+bottom-left, bottom-right
4 values = top-left, top-right, bottom-right, bottom-left`,
    syntax: "border-radius: length | % | initial | inherit;",
    values: [
      { value: "length", description: "The radius of each corner as a fixed length.", syntax_example: "div { border-radius: 10px; }", units_note: "Accepts px, em, rem." },
      { value: "%", description: "The radius as a percentage of the element's width and height.", syntax_example: "div { border-radius: 50%; }" },
      { value: "initial", description: "Resets to default (0).", syntax_example: "div { border-radius: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "div { border-radius: inherit; }" }
    ],
    examples: [
      { label: "Round all corners equally", code: `div {\n  border: 2px solid #c8a96e;\n  border-radius: 12px;\n}` },
      { label: "Perfect circle", code: `.avatar {\n  width: 100px;\n  height: 100px;\n  border-radius: 50%;\n}` }
    ],
    browser_support: { chrome: "4", edge: "12", firefox: "4", safari: "5", opera: "10.5" }
  },

  {
    ...
    category: "CSS2",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/pr_border-spacing.php",
    definition: "Sets the distance between the borders of adjacent table cells. Only works when border-collapse is set to separate.",
    default_value: "0",
    inherited: "yes",
    animatable: "yes",
    applies_to: ["table and inline-table elements"],
    note: "border-spacing has no effect when border-collapse: collapse is set.",
    syntax: "border-spacing: length | initial | inherit;",
    values: [
      { value: "length", description: "One value sets both horizontal and vertical spacing. Two values set horizontal then vertical.", syntax_example: "table { border-spacing: 10px; }", units_note: "Accepts px, em, rem." },
      { value: "initial", description: "Resets to default (0).", syntax_example: "table { border-spacing: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "table { border-spacing: inherit; }" }
    ],
    examples: [{ label: "Space between table cell borders", code: `table {\n  border-collapse: separate;\n  border-spacing: 10px 5px;\n}` }],
    browser_support: { chrome: "1", edge: "12", firefox: "1", safari: "1", opera: "4" }
  },

  {
    ...
    category: "CSS1",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/pr_border-style.php",
    definition: "Sets the style of all four borders of an element. Can specify one to four values for individual sides.",
    default_value: "none",
    inherited: "no",
    animatable: "no",
    applies_to: ["all elements"],
    note: "The border style must be set for any border to display, even if width and color are defined.",
    syntax: "border-style: none | solid | dashed | dotted | double | groove | ridge | inset | outset | hidden | initial | inherit;",
    values: [
      { value: "none", description: "Default. No border.", syntax_example: "div { border-style: none; }" },
      { value: "solid", description: "A solid single line.", syntax_example: "div { border-style: solid; }" },
      { value: "dashed", description: "A dashed line.", syntax_example: "div { border-style: dashed; }" },
      { value: "dotted", description: "A dotted line.", syntax_example: "div { border-style: dotted; }" },
      { value: "double", description: "Two solid lines. The border-width value is the sum of both lines and the space.", syntax_example: "div { border-style: double; }" },
      { value: "groove", description: "A 3D grooved border. The effect depends on the border-color.", syntax_example: "div { border-style: groove; }" },
      { value: "ridge", description: "A 3D ridged border.", syntax_example: "div { border-style: ridge; }" },
      { value: "inset", description: "A 3D inset border that makes the element look embedded.", syntax_example: "div { border-style: inset; }" },
      { value: "outset", description: "A 3D outset border that makes the element look raised.", syntax_example: "div { border-style: outset; }" },
      { value: "hidden", description: "Same as none, except for table elements.", syntax_example: "div { border-style: hidden; }" },
      { value: "initial", description: "Resets to default (none).", syntax_example: "div { border-style: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "div { border-style: inherit; }" }
    ],
    examples: [
      { label: "All border style options", code: `div.a { border-style: solid; }\ndiv.b { border-style: dashed; }\ndiv.c { border-style: dotted; }\ndiv.d { border-style: double; }\ndiv.e { border-style: groove; }\ndiv.f { border-style: ridge; }\ndiv.g { border-style: inset; }\ndiv.h { border-style: outset; }` }
    ],
    browser_support: { chrome: "1", edge: "12", firefox: "1", safari: "1", opera: "3.5" }
  },

  {
    ...
    category: "CSS1",
    group: "B",
    w3schools_url: "https://www.w3schools.com/cssref/pr_border-width.php",
    definition: "Sets the width of all four borders. Can specify one to four values for individual sides.",
    default_value: "medium",
    inherited: "no",
    animatable: "yes",
    applies_to: ["all elements"],
...
Incorrect: border-width: 2 px;
Correct:   border-width: 2px;`,
    syntax: "border-width: thin | medium | thick | length | initial | inherit;",
    values: [
      { value: "thin", description: "A thin border (typically 1px).", syntax_example: "div { border-width: thin; }" },
      { value: "medium", description: "Default. A medium border (typically 3px).", syntax_example: "div { border-width: medium; }" },
      { value: "thick", description: "A thick border (typically 5px).", syntax_example: "div { border-width: thick; }" },
      { value: "length", description: "A specific width in CSS length units.", syntax_example: "div { border-width: 2px; }", units_note: "Accepts px, em, rem." },
      { value: "initial", description: "Resets to default (medium).", syntax_example: "div { border-width: initial; }" },
      { value: "inherit", description: "Inherits from parent.", syntax_example: "div { border-width: inherit; }" }
    ],
    examples: [{ label: "Different widths per side", code: `div {\n  border-style: solid;\n  border-width: 1px 4px 2px 6px;\n  border-color: #c8a96e;\n}` }],
    browser_support: { chrome: "1", edge: "12", firefox: "1", safari: "1", opera: "3.5" }
  },
...
border-box:  total rendered width = 200px (padding is included)`,
...

  {
    ...
    animatable: "no",
    applies_to: ["all elements"],
    note: "box-reflect is not part of the official CSS specification. It is a WebKit extension supported in Chrome, Edge, and Safari but not in Firefox. Use with caution.",
    ...
    browser_support: { chrome: "4", edge: "79", firefox: "Not supported", safari: "4", opera: "15" }
  },

  // ─── END OF B SECTION (COMPLETE) ─────────────────────────────────────────
// ─── C ───────────────────────────────────────────────────────────────────────
...
Incorrect: /* comment */ @charset "UTF-8";`,
    ...
    examples: [{ label: "Declare UTF-8 encoding at top of CSS file", code: `@charset "UTF-8";\n\nbody {\n  font-family: 'Playfair Display', serif;\n}` }],
    browser_support: { chrome: "2", edge: "12", firefox: "1.5", safari: "4", opera: "9" }
  },
...

  {
    ...
    browser_support: { chrome: "105", edge: "105", firefox: "110", safari: "16", opera: "91" }
  },
...

  {
    ...
    browser_support: { chrome: "91", edge: "91", firefox: "33", safari: "17", opera: "77" }
  },
...
// ─── D ───────────────────────────────────────────────────────────────────────
// Paste these objects into atoz_properties_lessons array after the C section
...
- Ghost:        contents`,
  ...
  // ─── END OF D SECTION ─────────────────────────────────────────────────────
 // ─── E ───────────────────────────────────────────────────────────────────────
// Paste these objects into atoz_properties_lessons array after the D section
  ...
  // ─── END OF E SECTION ─────────────────────────────────────────────────────
  // ─── F ───────────────────────────────────────────────────────────────────────
// Paste these objects into atoz_properties_lessons array after the E section
...
3. ttf / otf`,
    ...
    values: [
      {
        value: "font-family",
        description: "Required. The name you assign to the font for use in CSS declarations.",
        syntax_example: "@font-face { font-family: 'MyFont'; src: url('myfont.woff2') format('woff2'); }"
      },
      {
        value: "src",
        description: "Required. The path to the font file. Multiple sources separated by commas provide fallbacks.",
        syntax_example: "@font-face {\n  font-family: 'MyFont';\n  src: url('myfont.woff2') format('woff2'),\n       url('myfont.woff') format('woff');\n}"
      },
      {
        value: "font-weight",
        description: "Optional. Specifies which weight this font file represents. Useful for loading different files per weight.",
        syntax_example: "@font-face { font-family: 'MyFont'; src: url('myfont-bold.woff2') format('woff2'); font-weight: bold; }"
      },
      {
        value: "font-style",
        description: "Optional. Specifies if this file is normal, italic, or oblique.",
        syntax_example: "@font-face { font-family: 'MyFont'; src: url('myfont-italic.woff2') format('woff2'); font-style: italic; }"
      },
      {
        value: "font-display",
        description: "Controls how the font is displayed while loading: auto, block, swap, fallback, optional.",
        syntax_example: "@font-face { font-family: 'MyFont'; src: url('myfont.woff2') format('woff2'); font-display: swap; }"
      }
    ],
    additional_properties: [
      {
        name: "font-display: swap",
        condition: "font-display: swap is a performance best practice — it shows the fallback font immediately while the custom font loads, then swaps it in, preventing invisible text during page load (FOIT).",
        css_version: "CSS3",
        path: "CSS3 > Fonts > @font-face > font-display",
        syntax_example: "@font-face { font-family: 'MyFont'; src: url('myfont.woff2') format('woff2'); font-display: swap; }",
        section_id: "css3-fonts-font-display"
      }
    ],
    examples: [
      {
        label: "Load and use a custom font",
        code: `@font-face {\n  font-family: 'Playfair';\n  src: url('playfair.woff2') format('woff2'),\n       url('playfair.woff') format('woff');\n  font-weight: normal;\n  font-style: normal;\n  font-display: swap;\n}\n\nbody {\n  font-family: 'Playfair', Georgia, serif;\n}`
      }
    ],
    browser_support: { chrome: "4", edge: "12", firefox: "3.5", safari: "3.1", opera: "10" }
  },
...
font-family: 'Arial', sans-serif; /* also valid */`,
...

  {
    ...
    values: [
      {
        value: "font-family",
        description: "Required. The color font this palette applies to.",
        syntax_example: "@font-palette-values --MyPalette { font-family: 'Bungee Shade'; base-palette: 0; }"
      },
      {
        value: "base-palette",
        description: "Selects which built-in palette from the font to use as a starting point.",
        syntax_example: "@font-palette-values --MyPalette { font-family: 'Rocher'; base-palette: 1; }"
      },
      {
        value: "override-colors",
        description: "Overrides specific colors in the palette by index number.",
        syntax_example: "@font-palette-values --MyPalette { font-family: 'Rocher'; override-colors: 0 #c8a96e, 1 #1a1a2e; }"
      }
    ],
    examples: [
      {
        label: "Custom color font palette",
        code: `@font-palette-values --GoldPalette {\n  font-family: 'Bungee Shade';\n  base-palette: 0;\n  override-colors: 0 #c8a96e, 1 #1a1a2e;\n}\n\nh1 {\n  font-family: 'Bungee Shade';\n  font-palette: --GoldPalette;\n}`
      }
    ],
    browser_support: { chrome: "101", edge: "101", firefox: "107", safari: "15.4", opera: "87" }
  },
...
// ─── G ───────────────────────────────────────────────────────────────────────
// Paste these objects into atoz_properties_lessons array after the F section
...
repeat(auto-fit, minmax(200px, 1fr)) = responsive columns that stretch to fill space`,
    ...
    values: [
      ...
      },
      {
        value: "fr",
        description: "A fractional unit of available space after fixed columns are placed.",
        syntax_example: ".container { grid-template-columns: 200px 1fr 1fr; }"
      },
      {
        value: "repeat(n, size)",
        description: "Repeats a column definition n times. Use auto-fill or auto-fit instead of n for responsive layouts.",
  ...
  // ─── END OF G SECTION ─────────────────────────────────────────────────────
 // ─── H ───────────────────────────────────────────────────────────────────────
// Paste these objects into atoz_properties_lessons array after the G section
...
Correct:   height: 200px;`,
  ...
  // ─── END OF H SECTION ─────────────────────────────────────────────────────
  // ─── I ───────────────────────────────────────────────────────────────────────
// Paste these objects into atoz_properties_lessons array after the H section
...
@import url('styles.css'); /* ignored — too late */`,
    ...
    values: [
      {
        value: "url('path')",
        description: "The path to the external CSS file using url() notation.",
        syntax_example: "@import url('https://fonts.googleapis.com/css2?family=Playfair+Display');"
      },
      {
        value: "'path'",
        description: "The path to the external CSS file as a string (without url()).",
        syntax_example: "@import 'variables.css';"
      },
      {
        value: "url('path') media-query",
        description: "Import a stylesheet conditionally based on a media query.",
        syntax_example: "@import url('print.css') print;\n@import url('mobile.css') screen and (max-width: 600px);"
      }
    ],
    additional_properties: [
      {
        name: "@layer",
        condition: "In modern CSS, @import can be combined with @layer to import a stylesheet into a specific cascade layer, giving you control over specificity order.",
        css_version: "CSS3",
        path: "CSS3 > At-Rules > @layer",
        syntax_example: "@import url('base.css') layer(base);",
        section_id: "css3-atrules-layer"
      }
    ],
    examples: [
      {
        label: "Import Google Font at top of stylesheet",
        code: `@import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700&display=swap');\n\nbody {\n  font-family: 'Playfair Display', serif;\n}`
      },
      {
        label: "Import local partials",
...
Any % value defines an intermediate step.`,
    syntax: "@keyframes animationname { from { ... } to { ... } } or { 0% { ... } 50% { ... } 100% { ... } }",
    values: [
      {
        value: "from",
        description: "Shorthand for 0% — the starting styles of the animation.",
        syntax_example: "@keyframes slide { from { left: 0; } to { left: 300px; } }"
      },
      {
        value: "to",
        description: "Shorthand for 100% — the ending styles of the animation.",
        syntax_example: "@keyframes fade { from { opacity: 1; } to { opacity: 0; } }"
      },
      {
        value: "percentage",
        description: "Any percentage from 0% to 100% defines the styles at that point in the animation cycle.",
        syntax_example: "@keyframes pulse { 0% { transform: scale(1); } 50% { transform: scale(1.1); } 100% { transform: scale(1); } }"
      }
    ],
    additional_properties: [
      {
        name: "animation-name",
        condition: "The @keyframes rule only activates when referenced by animation-name on an element. The name in @keyframes and animation-name must match exactly.",
        css_version: "CSS3",
        path: "CSS3 > Animations > animation-name",
        syntax_example: "div { animation-name: slide; animation-duration: 1s; }\n@keyframes slide { from { left: 0; } to { left: 200px; } }",
        section_id: "css3-animations-animation-name"
      },
      {
        name: "animation",
        condition: "Use the animation shorthand to apply @keyframes along with duration, timing, delay, and iteration count in one declaration.",
        css_version: "CSS3",
        path: "CSS3 > Animations > animation",
        syntax_example: "div { animation: slide 1s ease-in-out infinite; }",
        section_id: "css3-animations-animation"
      }
    ],
    examples: [
      {
        label: "Simple slide animation",
        code: `@keyframes slidein {\n  from { transform: translateX(-100%); opacity: 0; }\n  to   { transform: translateX(0);    opacity: 1; }\n}\n\n.card {\n  animation: slidein 0.5s ease-out;\n}`
      },
      {
        label: "Multi-step pulse animation",
        code: `@keyframes pulse {\n  0%   { transform: scale(1);    box-shadow: 0 0 0 0 rgba(200, 169, 110, 0.7); }\n  50%  { transform: scale(1.05); box-shadow: 0 0 0 10px rgba(200, 169, 110, 0); }\n  100% { transform: scale(1);    box-shadow: 0 0 0 0 rgba(200, 169, 110, 0); }\n}\n\n.btn {\n  animation: pulse 2s infinite;\n}`
      },
      {
        label: "Color fade loop",
        code: `@keyframes colorshift {\n  0%   { background-color: #1a1a2e; }\n  50%  { background-color: #0f3460; }\n  100% { background-color: #1a1a2e; }\n}\n\nbody {\n  animation: colorshift 8s ease infinite;\n}`
      }
    ],
    browser_support: { chrome: "43", edge: "12", firefox: "16", safari: "9", opera: "30" }
  },
...
Then define each layer anywhere in the file:
@layer base { ... }
@layer utilities { ... }`,
    syntax: "@layer layername { /* CSS rules */ } or @layer layername;",
    values: [
      {
        value: "@layer name { rules }",
        description: "Defines a named cascade layer containing CSS rules.",
        syntax_example: "@layer base {\n  body { margin: 0; font-family: sans-serif; }\n}"
      },
      {
        value: "@layer name;",
        description: "Declares a layer order without defining rules yet. Used to set priority at the top of a stylesheet.",
        syntax_example: "@layer reset, base, components, utilities;"
      },
      {
        value: "@layer (anonymous)",
        description: "A layer without a name. Cannot be appended to later.",
        syntax_example: "@layer {\n  p { color: #333; }\n}"
      }
    ],
    additional_properties: [
      {
        name: "@import with @layer",
        condition: "You can import an external stylesheet directly into a named layer using @import with the layer() keyword.",
        css_version: "CSS3",
        path: "CSS3 > At-Rules > @import",
        syntax_example: "@import url('reset.css') layer(reset);",
        section_id: "css3-atrules-import"
      }
    ],
    examples: [
      {
        label: "Define and use cascade layers",
        code: `/* Declare layer order — last = highest priority */\n@layer reset, base, components, utilities;\n\n@layer reset {\n  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }\n}\n\n@layer base {\n  body { font-family: 'Crimson Pro', serif; color: #e8e8e8; background: #1a1a2e; }\n}\n\n@layer components {\n  .card { border: 1px solid #c8a96e; border-radius: 8px; padding: 24px; }\n}\n\n@layer utilities {\n  .text-gold { color: #c8a96e; }\n  .mt-auto  { margin-top: auto; }\n}`
      }
    ],
    browser_support: { chrome: "99", edge: "99", firefox: "97", safari: "15.4", opera: "85" }
  },
...
inside: The marker is part of the content flow. Wrapped text aligns under the marker.`,
  ...
  // ─── END OF I, J, K, L SECTIONS ───────────────────────────────────────────
  
// ─── M ───────────────────────────────────────────────────────────────────────
// Paste these objects into atoz_properties_lessons array after the L section
...
Media types: all, screen, print, speech`,
    ...
    values: [
      {
        value: "min-width",
        description: "Applies styles when the viewport is at least the specified width. Used in mobile-first design.",
        syntax_example: "@media (min-width: 768px) { .sidebar { display: block; } }"
      },
      {
        value: "max-width",
        description: "Applies styles when the viewport is at most the specified width. Used in desktop-first design.",
        syntax_example: "@media (max-width: 767px) { .nav { flex-direction: column; } }"
      },
      {
        value: "orientation: portrait / landscape",
        description: "Applies styles based on device orientation.",
        syntax_example: "@media (orientation: landscape) { .hero { height: 50vh; } }"
      },
      {
        value: "prefers-color-scheme: dark / light",
        description: "Applies styles based on the user's OS color mode preference.",
        syntax_example: "@media (prefers-color-scheme: dark) { body { background: #1a1a2e; color: #e8e8e8; } }"
      },
      {
        value: "prefers-reduced-motion",
        description: "Applies styles when the user has requested reduced motion in their OS settings.",
        syntax_example: "@media (prefers-reduced-motion: reduce) { * { animation: none !important; transition: none !important; } }"
      },
      {
        value: "print",
        description: "Applies styles only when the page is being printed.",
        syntax_example: "@media print { .no-print { display: none; } }"
      }
    ],
    additional_properties: [
      {
        name: "@container",
        condition: "Use @container queries instead of @media when you want to apply styles based on a parent element's size rather than the viewport size — enabling truly component-driven responsive design.",
        css_version: "CSS3",
        path: "CSS3 > At-Rules > @container",
        syntax_example: ".card-wrapper { container-type: inline-size; }\n@container (min-width: 400px) { .card { flex-direction: row; } }",
        section_id: "css3-atrules-container"
      }
    ],
    examples: [
      {
        label: "Mobile-first responsive layout",
        code: `/* Base: single column */\n.grid {\n  display: grid;\n  grid-template-columns: 1fr;\n  gap: 16px;\n}\n\n/* Tablet: two columns */\n@media (min-width: 768px) {\n  .grid { grid-template-columns: 1fr 1fr; }\n}\n\n/* Desktop: three columns */\n@media (min-width: 1024px) {\n  .grid { grid-template-columns: repeat(3, 1fr); }\n}`
      },
      {
    ...
    browser_support: { chrome: "21", edge: "12", firefox: "3.5", safari: "4.1", opera: "9" }
  },
...
// ─── N ───────────────────────────────────────────────────────────────────────
// Paste these objects into atoz_properties_lessons array after the M section
...
A prefixed namespace only applies to elements using that prefix in selectors.`,
    ...
    values: [
      {
        value: "url('namespace-uri')",
        description: "Declares a default namespace — applies to all unprefixed elements.",
        syntax_example: "@namespace url('http://www.w3.org/1999/xhtml');"
      },
      {
        value: "prefix url('namespace-uri')",
        description: "Declares a prefixed namespace for use in selectors.",
        syntax_example: "@namespace svg url('http://www.w3.org/2000/svg');\nsvg|circle { fill: #c8a96e; }"
      }
    ],
    examples: [
      {
        label: "Declare SVG namespace",
        code: `@namespace url('http://www.w3.org/1999/xhtml');\n@namespace svg url('http://www.w3.org/2000/svg');\n\nsvg|circle {\n  fill: #c8a96e;\n  stroke: #1a1a2e;\n}`
      }
    ],
    browser_support: { chrome: "1", edge: "12", firefox: "1", safari: "1", opera: "8" }
  },
...

  {
    ...
    values: [
      {
        value: "fill",
        description: "Default. The content is stretched to fill the container. Aspect ratio is NOT preserved — the image may appear distorted.",
        syntax_example: "img { object-fit: fill; }"
      },
      {
        value: "contain",
        description: "The content is scaled to fit inside the container while preserving aspect ratio. May leave empty space (letterboxing).",
        syntax_example: "img { object-fit: contain; }"
      },
      {
        value: "cover",
        description: "The content is scaled to cover the entire container while preserving aspect ratio. May be cropped.",
        syntax_example: "img { object-fit: cover; }"
      },
      {
        value: "scale-down",
        description: "The content is sized as if none or contain was specified, whichever results in the smaller size.",
        syntax_example: "img { object-fit: scale-down; }"
      },
      {
        value: "none",
        description: "The content is not resized — displayed at its natural size.",
        syntax_example: "img { object-fit: none; }"
      },
      {
        value: "initial",
        description: "Resets to default (fill).",
        syntax_example: "img { object-fit: initial; }"
      },
      {
        value: "inherit",
        description: "Inherits from parent.",
        syntax_example: "img { object-fit: inherit; }"
      }
    ],
    additional_properties: [
      {
        name: "object-position",
        condition: "Use object-position to control which part of the image is shown when object-fit: cover crops it. Default is center center.",
        css_version: "CSS3",
        path: "CSS3 > Images > object-position",
        syntax_example: "img { object-fit: cover; object-position: top center; }",
        section_id: "css3-images-object-position"
      }
    ],
    examples: [
      {
        label: "Card image that fills without distortion",
        code: `.card-img {\n  width: 100%;\n  height: 200px;\n  object-fit: cover;\n  object-position: center;\n}`
      }
    ],
    browser_support: { chrome: "32", edge: "79", firefox: "36", safari: "10", opera: "19" }
  },

  {
    ...
    values: [
      {
        value: "50% 50%",
        description: "Default. The content is centered both horizontally and vertically.",
        syntax_example: "img { object-position: 50% 50%; }"
      },
      {
        value: "keyword",
        description: "Position keywords: top, right, bottom, left, center — used alone or in combination.",
        syntax_example: "img { object-position: top center; }"
      },
      {
        value: "length",
        description: "Fixed position from the top-left corner.",
        syntax_example: "img { object-position: 20px 40px; }",
        units_note: "Accepts px, em, rem, %."
      },
      {
        value: "initial",
        description: "Resets to default (50% 50%).",
        syntax_example: "img { object-position: initial; }"
      },
      {
        value: "inherit",
        description: "Inherits from parent.",
        syntax_example: "img { object-position: inherit; }"
      }
    ],
    examples: [
      {
        label: "Show top of portrait photo",
...
Correct:   padding: 20px;`,
...

  {
    ...
    examples: [
      {
        label: "Print page margins",
        code: `@media print {\n  @page {\n    margin: 2cm;\n    size: A4 portrait;\n  }\n}`
      }
    ],
    browser_support: { chrome: "2", edge: "12", firefox: "19", safari: "6", opera: "6" }
  },

  {
    ...
    examples: [{ label: "New page after each section", code: `@media print {\n  section { page-break-after: always; }\n}` }],
    browser_support: { chrome: "1", edge: "12", firefox: "1", safari: "1.2", opera: "7" }
  },

  {
    ...
    examples: [{ label: "New page before each chapter heading", code: `@media print {\n  h1 { page-break-before: always; }\n}` }],
    browser_support: { chrome: "1", edge: "12", firefox: "1", safari: "1.2", opera: "7" }
  },

  {
    ...
    examples: [{ label: "Keep figures intact when printing", code: `@media print {\n  figure { page-break-inside: avoid; }\n}` }],
    browser_support: { chrome: "1", edge: "12", firefox: "19", safari: "1.3", opera: "7" }
  },
...
initial-value — the default value`,
    ...
    values: [
      {
        value: "syntax",
        description: "Defines the type of the custom property.",
        syntax_example: "@property --my-color { syntax: '<color>'; inherits: false; initial-value: #c8a96e; }"
      },
      {
        value: "inherits",
        description: "Whether the property inherits its value from the parent element.",
        syntax_example: "@property --my-size { syntax: '<length>'; inherits: true; initial-value: 0px; }"
      },
      {
        value: "initial-value",
        description: "The default value of the custom property.",
        syntax_example: "@property --my-angle { syntax: '<angle>'; inherits: false; initial-value: 0deg; }"
      }
    ],
    additional_properties: [
      {
        name: "CSS custom properties (var())",
        condition: "CSS custom properties defined with @property are used the same way as regular --variables using var(), but they are typed and animatable.",
        css_version: "CSS3",
        path: "CSS3 > Functions > var()",
        syntax_example: "@property --hue { syntax: '<angle>'; inherits: false; initial-value: 0deg; }\n.element { color: hsl(var(--hue), 80%, 60%); }",
        section_id: "css3-functions-var"
      }
    ],
    examples: [
      {
        label: "Animate a gradient via custom property",
        code: `@property --gradient-angle {\n  syntax: '<angle>';\n  inherits: false;\n  initial-value: 0deg;\n}\n\n.animated-gradient {\n  background: linear-gradient(var(--gradient-angle), #1a1a2e, #c8a96e);\n  animation: rotate-gradient 4s linear infinite;\n}\n\n@keyframes rotate-gradient {\n  to { --gradient-angle: 360deg; }\n}`
      }
    ],
    browser_support: { chrome: "85", edge: "85", firefox: "128", safari: "16.4", opera: "71" }
  },
...
This sets: outer quotes = " " and inner (nested) quotes = ' '`,
  ...
  // ─── END OF N, O, P, Q SECTIONS ───────────────────────────────────────────
 // ─── R ───────────────────────────────────────────────────────────────────────
// Paste these objects into atoz_properties_lessons array after the Q section
...
// ─── S ───────────────────────────────────────────────────────────────────────
// Paste these objects into atoz_properties_lessons array after the R section
...
scale: 1 2 3   = x y z scaling (3D)`,
    ...
    values: [
      {
        ...
        description: "Styles apply only inside elements matching .component.",
        syntax_example: "@scope (.card) {\n  h2 { font-size: 1.2rem; }\n  p  { color: #ccc; }\n}"
      },
      {
        value: "@scope (.root) to (.limit)",
        description: "Styles apply inside .root but stop at .limit — a donut scope.",
        syntax_example: "@scope (.article) to (.ad-block) {\n  p { line-height: 1.6; }\n}"
      }
    ],
    examples: [
      {
        label: "Scoped card styles",
        code: `@scope (.card) {\n  h2 {\n    font-size: 1.25rem;\n    color: #c8a96e;\n  }\n  p {\n    font-size: 0.9rem;\n    line-height: 1.5;\n  }\n}`
      }
    ],
    browser_support: { chrome: "118", edge: "118", firefox: "Not supported", safari: "17.4", opera: "104" }
  },
    ...
    values: [
      {
        ...
        description: "Defines the starting values for properties before the first transition fires.",
        syntax_example: ".dialog {\n  opacity: 1;\n  transition: opacity 0.3s;\n}\n\n@starting-style {\n  .dialog { opacity: 0; }\n}"
      }
    ],
    examples: [
      {
        label: "Fade in dialog on open",
        code: `.dialog[open] {\n  opacity: 1;\n  translate: 0 0;\n  transition: opacity 0.3s, translate 0.3s;\n}\n\n@starting-style {\n  .dialog[open] {\n    opacity: 0;\n    translate: 0 -20px;\n  }\n}`
      }
    ],
    browser_support: { chrome: "117", edge: "117", firefox: "129", safari: "17.5", opera: "103" }
  },

  {
    ...
    values: [
      {
        value: "@supports (property: value)",
        description: "Applies styles only if the browser supports the specified property and value.",
        syntax_example: "@supports (display: grid) {\n  .container { display: grid; }\n}"
      },
      {
        value: "@supports not (property: value)",
        description: "Applies styles only if the browser does NOT support the feature.",
        syntax_example: "@supports not (display: grid) {\n  .container { display: flex; }\n}"
      },
      {
        value: "@supports (condition) and (condition)",
        description: "Both conditions must be true.",
        syntax_example: "@supports (display: grid) and (gap: 1rem) {\n  .container { display: grid; gap: 1rem; }\n}"
      },
      {
        value: "@supports (condition) or (condition)",
        description: "Either condition being true applies the styles.",
        syntax_example: "@supports (transform: rotate(1deg)) or (-webkit-transform: rotate(1deg)) {\n  div { transform: rotate(45deg); }\n}"
      }
    ],
    examples: [
      {
        label: "Grid with flexbox fallback",
        code: `/* Fallback for all browsers */\n.container {\n  display: flex;\n  flex-wrap: wrap;\n}\n\n/* Enhanced for grid-supporting browsers */\n@supports (display: grid) {\n  .container {\n    display: grid;\n    grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));\n  }\n}`
      }
    ],
    browser_support: { chrome: "28", edge: "12", firefox: "22", safari: "9", opera: "12.1" }
  },
...
Correct:   transition-duration: 0.3s;`,
  ...
  // ─── END OF S SECTION ─────────────────────────────────────────────────────
 // ─── T ───────────────────────────────────────────────────────────────────────
// Paste these objects into atoz_properties_lessons array after the S section

  {
    ...
    additional_properties: [
      {
        name: "direction",
        condition: "unicode-bidi must always be used together with the direction property for bidirectional text control.",
        css_version: "CSS2",
        path: "CSS2 > Text Properties > direction",
        syntax_example: ".rtl { direction: rtl; unicode-bidi: embed; }",
        section_id: "css2-text-direction"
      }
    ],
    examples: [
      {
        label: "Embed RTL text inline",
        code: `.arabic {\n  direction: rtl;\n  unicode-bidi: embed;\n}`
      }
    ],
    browser_support: { chrome: "2", edge: "12", firefox: "1", safari: "1.3", opera: "9.2" }
  },
...
You can make a child visible again with visibility: visible even if the parent is hidden.`,
  ...
  // ─── END OF T, U, V SECTIONS ──────────────────────────────────────────────
  // ─── W ───────────────────────────────────────────────────────────────────────
// Paste these objects into atoz_properties_lessons array after the V section
...
This means a child with z-index: 9999 inside a parent with z-index: 1 will always be behind elements outside the parent with z-index: 2.`,
  ...
  // ─── END OF W AND Z SECTIONS ──────────────────────────────────────────────
  // This is the final section of the A-Z dataset.
  // Close the array with ]; at the end of the complete file.
];
